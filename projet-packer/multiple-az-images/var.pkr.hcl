...
variable image_name_windows {
  type    = string
  default = "your_final_image_name"
}
variable image_version_windows {
  type = string
}
variable source_image_sku_w {
  type = string
}
variable source_image_publisher_w {
  type = string
}
variable source_image_offer_w {
  type = string
}
...
variable source_image_sku_r {
  type = string
}
variable source_image_publisher_r {
  type = string
}
variable source_image_offer_r {
  type = string
}
